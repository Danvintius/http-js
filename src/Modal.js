      ...
      if (this.modalHeader.innerText === 'Добавить тикет') {
        this.negotiator.createRequest({
          ...
          callback: (response) => {
            ...
            console.log('Новый тикет был добавлен.'); // eslint-disable-line no-console
          },
        });
        ...
        this.negotiator.createRequest({
          ...
          callback: (response) => {
            ...
            this.modalFormControls.classList.remove('active');
            console.log('Измененные значения сохранены.'); // eslint-disable-line no-console
          },
        });
        ...
        this.negotiator.createRequest({
          ...
          callback: () => {
            ...
            console.log(`Тикет с id #${ticketId} был удален.`); // eslint-disable-line no-console
          },
        });
      }
